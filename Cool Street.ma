...
//Name: Cool Street.ma
//Last modified: Thu, Feb 01, 2018 02:15:25 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.9018943956714236 39.432460013560302 62.761693805999379 ;
	setAttr ".r" -type "double3" -30.938352729140366 3962.5999999974447 1.9898951340749988e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5CD07F29-48FC-6FF9-8B2B-C48E7800B2E9";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 71.472465920522794;
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo1";
	rename -uid "4FC47E8B-41D1-9780-F79B-3593E7591760";
	setAttr -s 2 ".tgi";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 6952.1517383983264 -1641.6666014326972 ;
	setAttr ".tgi[0].vh" -type "double2" 13760.942676632492 202.38094433905613 ;
	setAttr ".tgi[0].ni[0].x" -157.14285278320312;
	setAttr ".tgi[0].ni[0].y" 55.714286804199219;
	setAttr ".tgi[0].ni[0].nvs" 1923;
	setAttr ".tgi[1].tn" -type "string" "Untitled_2";
	setAttr ".tgi[1].vl" -type "double2" -5603.6629490211344 -3120.6519074512194 ;
	setAttr ".tgi[1].vh" -type "double2" 5594.519218497624 3106.7462723550225 ;
select -ne :time1;
	setAttr ".o" 55;
	setAttr ".unw" 55;
